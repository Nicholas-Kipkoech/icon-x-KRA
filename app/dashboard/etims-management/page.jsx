        ...
        <>
          ...
          <div className="flex flex-wrap justify-evenly border rounded p-4">
            <CustomInput
              ...
              type={"number"}
              className={"h-[40px] sm:w-[20rem] w-[30vw] border rounded-md p-2"}
            />
            <CustomInput
            ...
            <CustomSelect
              ...
              className={"h-[60px] sm:w-[20rem] w-[30vw] rounded-md p-2"}
            />
            <CustomSelect
            ...
            <div className="flex flex-wrap justify-evenly border rounded p-4">
              <>
                <CustomInput
                  ...
                  className={
                    "h-[40px] sm:w-[20rem] w-[30vw] border rounded-md p-2"
                  }
                />
                <CustomInput
                  name={"Customer Name"}
